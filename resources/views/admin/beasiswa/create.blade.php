...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Tambah Data Beasiswa</h1>
        <p class="page-subtitle">Input data beasiswa baru</p>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_beasiswa') is-invalid @enderror"
                        name="nama_beasiswa" value="{{ old('nama_beasiswa') }}" placeholder="Contoh: Beasiswa Prestasi 2025"
                        required>
                    @error('nama_beasiswa')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('jenis_beasiswa') is-invalid @enderror" name="jenis_beasiswa"
                        ...
                        <option value="prestasi" {{ old('jenis_beasiswa') == 'prestasi' ? 'selected' : '' }}>Prestasi
                        </option>
                        <option value="tidak mampu" {{ old('jenis_beasiswa') == 'tidak mampu' ? 'selected' : '' }}>Tidak
                            Mampu</option>
                        <option value="full" {{ old('jenis_beasiswa') == 'full' ? 'selected' : '' }}>Full/Penuh</option>
                    </select>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="3"
                        placeholder="Deskripsi singkat tentang beasiswa ini">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('nominal') is-invalid @enderror" name="nominal"
                        value="{{ old('nominal') }}" min="0" placeholder="Opsional, nominal dalam Rupiah">
                    @error('nominal')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_buka') is-invalid @enderror"
                        name="tanggal_buka" value="{{ old('tanggal_buka') }}" required>
                    @error('tanggal_buka')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_tutup') is-invalid @enderror"
                        name="tanggal_tutup" value="{{ old('tanggal_tutup') }}" required>
                    @error('tanggal_tutup')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror"
                        name="tahun_ajaran" value="{{ old('tahun_ajaran', date('Y') . '/' . (date('Y') + 1)) }}"
